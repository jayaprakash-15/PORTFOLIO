...
const Contact = ({isDarkMode}) => {
  ...
  return (
    <div id='contact' className='w-full px-[4%] sm:px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none' >
        ...
        <form onSubmit={onSubmit} className='max-w-2xl mx-auto'>
            ...
            shadow-md  hover:-translate-y-1  hover:shadow-red_circle'
